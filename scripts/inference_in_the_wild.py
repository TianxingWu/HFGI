...
from datasets.inference_dataset import InferenceDataset, InTheWildDataset
...
def main(args):
    ...
    for i, batch in enumerate(data_loader):
        ...
        # =========================================================
            ...
            im_save_path = os.path.join(edit_directory_path, f"{orig_name}-{args.edit_attribute}.jpg")
...
def setup_data_loader(args, opts):
    ...
    test_dataset = InTheWildDataset(root=images_path,
